...
await page.screenshot({ path: path.join(shotDir, "cluster-fix-01-before.png") });

// Click the "9" cluster circle
await page.mouse.click(770, 596);
await page.waitForTimeout(1500);
await page.screenshot({ path: path.join(shotDir, "cluster-fix-02-after-click.png") });
